...
Cursor skill: разбор XML-выгрузки 1С на скорость и оптимальность. Результат — HTML с **самодостаточными вставками** (процедура/область целиком, запрос уже внутри).
...
Нужны файлы `SKILL.md` и `protocol.md` в корне.
